...
function get_cc(cb) {
  var req_url = "https://explorer.devcore.io/ext/connections";
  //var req_url = "http://localexplorer.devcore.io/ext/connections";
...
function proc_cc(bresponse) {
    ...
    var mapData = JSON.stringify(ccobj).toLowerCase();
    //console.log(mapData);
    var jsonData = 'var sample_data = ' +mapData+ ';';
